...
public class Constants {
    ...
    public static final String ADMIN_ADMINBASIS_JSP = "/admin/adminbasis.jsp";
    ...
    public static final String INVALID_HALLS = "invalidHalls";
    ...
    public static final String NOT_FOUND = "Exhibition not found";
